...
const Testimonial = () => {
  ...
  return (
    <div className="py-16 parent bg-neutral ">
      ...
      >
        <h3 className="text-center text-accent">What Do They Say?</h3>
        ...
        <Slider {...settings}>
          {Reviews.map((review) => (
            <div key={review.id} className="mt-6">
              <div className="mx-4 rounded-lg shadow-xl single-blog cursor-pointer border-2 border-primary pt-6 flex flex-col justify-between h-[300px]">
                <div className="px-6">

...
import logoMSN from "../../../assets/images/aaroha.jpg";
  ...
  return (
    <div>
      ...
      >
        <div>
          <Link to="/">
            <img src={logoMSN} alt="Aaroha Soft" className="w-32 sm:w-46" />
          </Link>
          <h1 className="text-2xl font-bold text-black ">Aaroha Soft</h1>
          ...
          <div className="flex items-center my-1">
            ...
            <h3 className="font-medium text-accent">+977 9824151824</h3>
          </div>
          <div className="flex items-center my-1">
            <MdEmail className="mr-6 text-2xl text-accent"></MdEmail>
            <h3 className="font-medium text-accent">aarohasoft@gmail.com</h3>
          </div>
        </div>
        {/* Links */}
        <div>
          <span className="font-bold text-black">Links</span>
          <Link
            to="/"
        ...
        {/* Focus & Services */}
        <div>
          <span className="font-bold text-accent">Focus & Services</span>
          <Link
            to="/packages"
            className="link link-hover hover:text-primary text-accent"
          >
      ...
      <footer className="px-10 py-6 text-sm text-center text-base-100 border-base-300 bg-neutral ">
        ...
        <div className="flex flex-col items-center justify-center mt-6 md:flex-row text-accent">
          <p>&copy; Copyright 2024, Aaroha Soft - All Rights Reserved</p>
        </div>
      </footer>
      <ButtonWa />
    </div>

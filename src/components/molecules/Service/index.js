...
const Service = () => {
  ...
  return (
    <div className="py-20 parent bg-neutral">
      ...
      >
        <h3 className="text-center text-accent">Focus & Services</h3>
        <h1 className="text-4xl font-semibold text-center">
          Digital & Creative <span className="text-primary">Solutions</span>
        </h1>
        <BottomLine />
        <h2 className="py-5 text-center text-accent">
          We focus on providing holistic solutions for your business in building
          your brand effectively & consistently across various digital channels.
          We will help you develop your business to achieve your company's goals
          more effectively.
        </h2>
      </motion.div>
